// TODO: Legacy adapters - removed in monorepo refactor
// These were never implemented and this factory is not used in production
// import { BrokerAdapter } from './broker';
// import { BitgetAdapter } from './bitget';

export type SupportedBroker = 'bitget' | 'binance' | 'bybit' | 'okx';

// Temporary stub until we decide to remove or implement this factory
