...
export const BROKER_RULES: Record<string, BrokerRules> = {
  deribit: createBrokerRules(50, 0.5, 10, 10),
  binance: createBrokerRules(125, 0.1, 0.001, 10),
  bybit: createBrokerRules(100, 0.5, 0.001, 10),
  okx: createBrokerRules(125, 0.1, 0.001, 10),
  kraken: createBrokerRules(5, 0.5, 0.001, 10),
  bitmex: createBrokerRules(100, 0.5, 1, 1),
  mexc: createBrokerRules(200, 0.01, 0.001, 10),
  coinbase: createBrokerRules(5, 0.01, 0.001, 10),
  kucoin: createBrokerRules(100, 0.5, 0.001, 10),
  gateio: createBrokerRules(100, 0.1, 0.001, 10),
  huobi: createBrokerRules(125, 0.1, 0.001, 10),
  phemex: createBrokerRules(100, 0.5, 0.001, 10),
  bitget: createBrokerRules(125, 0.1, 0.001, 10),
  bitstamp: createBrokerRules(3, 0.01, 0.001, 10),
  bitfinex: createBrokerRules(10, 0.1, 0.001, 10),
};
